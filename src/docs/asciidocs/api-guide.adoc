...
- **NOTIF_FROM** - Email address to be used as sender of the notifications (also used as username for SMTP authentication in the current setup, although by no means mandatory)
